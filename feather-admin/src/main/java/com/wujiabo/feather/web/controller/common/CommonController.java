...
import com.wujiabo.feather.common.utils.file.FileUtils;
import com.wujiabo.feather.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response) {
        try {
            ...
            String filePath = FeatherConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = FeatherConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletResponse response)
        ...
        try {
            ...
            // 本地资源路径
            String localPath = FeatherConfig.getProfile();
            // 数据库资源地址
