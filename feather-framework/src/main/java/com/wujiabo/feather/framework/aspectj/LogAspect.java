...
import com.wujiabo.feather.common.enums.BusinessStatus;
import com.wujiabo.feather.common.enums.HttpMethod;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.wujiabo.feather.common.annotation.Log)")
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, TSysOperLog operLog) throws Exception {
        // 设置action动作
