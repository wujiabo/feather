package com.wujiabo.opensource.feather.util.AutoCode;
...
//	        templates.add("auto_code/说明.txt.vm");
	...
	public static void autoCodeOneModel(SysUtilService sysUtilService, TsysTables tables,
        ...
        map.put("conditionQueryField_a", com.wujiabo.opensource.feather.util.StringUtils.firstLowerCase(conditionQueryField));
